...
//4.Создать квадратный двумерный целочисленный массив (количество строк и столбцов одинаковое), и с помощью цикла(-ов) заполнить его диагональные элементы единицами;
    ...
    public static void main(String[] args) {
        ...
        int [] replacedArray = replaceNumbers(array); // С помощью цикла и условия заменить 0 на 1, 1 на 0;

        int [] filledArray = fillInArray(arr); //в пустом заданном массиве arr[8] с помощью цикла заполнить его значениями 0 3 6 9 12 15 18 21;

        multiplicationNumberslessThanSix(arrayB);   //.пройти по заданному массиву циклом, и числа меньшие 6 умножить на 2;
        System.out.println("Square matrix");
        makingMainDiagonal(squareArray);   //4.Создать квадратный двумерный целочисленный массив (количество строк и столбцов одинаковое), и с помощью цикла(-ов) заполнить его диагональные элементы единицами;

        maxAndMin(minMax); //найти мин и макс

         //Смещение
        int[] arrayC = {1, 5, 3, 2, 11, 4, 5, 2, 4, 8, 9, 1};
        Scanner myObj = new Scanner(System.in);
        System.out.println("Введите число,на сколько вы хотите сместить массив: " + Arrays.toString(arrayC));
        int shift = myObj.nextInt();
        int [] shifterArray = shiftOfNumbers(arrayC, shift);
        System.out.println(Arrays.toString(shifterArray));

        //Проверка сумм левой и правой части массива на равенство
        int [] arrayCheckBalanceOne = {2, 2, 2, 1, 2, 2, 10, 1};
        int [] arrayCheckBalanceTwo = {1, 1, 1,  2, 1};
        boolean arrayCheckOne = checkBalance(arrayCheckBalanceOne);
        System.out.println(arrayCheckOne);
        boolean arrayCheckTwo = checkBalance(arrayCheckBalanceTwo);
        System.out.println(arrayCheckTwo);
